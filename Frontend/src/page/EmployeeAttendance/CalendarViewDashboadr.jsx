...
const CalendarViewDashboard = ({ currentDate, setCurrentDate, searchTerm, setSearchTerm }) => {
        ...
        <div className="bg-white rounded-lg overflow-hidden">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative ">
                            <button
                                ...
                                className="flex items-center justify-between border border-gray-300 rounded-lg px-4 py-2 hover:bg-gray-50 min-w-[220px]"
                            >
                                <span className="text-sm text-gray-700">
                                    {selectedEmployee ? selectedEmployee.employeeName : 'Select an employee'}
                                </span>
                                <ChevronDown className="h-4 w-4 text-gray-400" />
                            </button>

                            {showEmployeeDropdown && (
                                <div className="absolute top-full left-0 mt-1 w-[300px] bg-white border border-gray-300 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto">
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-7 gap-2 mb-4">
                    {weekDays.map((day) => (
                        <div key={day} className="p-1 text-center text-sm font-semibold text-gray-700 bg-gray-50 rounded-lg">
                            {day}
                        </div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-7 gap-1">
                    {days.map((day, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`h-12 border-2 rounded-md p-1 w-12 
                                    ...
                                    <div className="h-full flex flex-col">
                                        ...
                                        {selectedEmployee && (
                                            <div className="flex-1 flex items-center justify-center">
                                                <div className={`w-5 h-3 rounded-lg flex items-center justify-center text-[10px] font-semibold 
                                                           ${attendanceStatus && attendanceStatus !== 'NA' ? getCalendarStatusColor(attendanceStatus) + ' text-white' : 'bg-gray-200 text-gray-500'}
                                                             `}>
                                                    {/* Optional label */}
                                                </div>
                                            </div>
